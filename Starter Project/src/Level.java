...
public class Level {
    ...
    private static final double INITIAL_ROUGHNESS = .8; // Adjust for more or less jaggedness
    ...
    private void generateTerrain() {
        ...
        terrain[0] = Math.max(-0.25f, Math.min(0.5f, gaussianRandom(random) +.5 ));
    ...
    private void addLandingZones() {
        ...
        int zoneWidth = NUM_POINTS / 10; // Width of each zone
